...
function stitch_slicewise(img_top, img_bottom, st_tfm, slice_tfms, out_type=Float64; octr=center(view(img_top,:,:,1,1)), correct_bias=true, sqrt_tfm=false, flip_y_bottom=true)
